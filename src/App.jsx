  ...
  return (
    ...
    <div className="app">
      <div className="hdr">
        ...
        <div className="hdr-user" style={{cursor:"pointer"}} onClick={()=>{setTab("settings");setSettView("main");}}>👤 {currentUser?.firstName}</div>
      </div>
